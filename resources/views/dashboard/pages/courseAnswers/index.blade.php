    ...
    <div class="tab-content padding-4">
        ...
        <div class="widget-toolbar">
            ...
            <div class="d-none d-md-block">
                ...
                <a href="{{ route('courseAnswers.create') }}" class="btn btn-primary btn-xs"><i
                        class="ace-icon fa fa-plus"></i>Create</a>
                        <a href="{{ route('courseAnswers.soft') }}" class="btn btn-xs btn-danger">
                    ...
                    @endforeach
                        ...
                        <td>
                            <div class="hidden-sm hidden-xs action-buttons" style="display:flex;">
                                ...
                                <a class="green" href="{{ route('courseAnswers.edit', $data->uuid) }}">
                                    <i class="ace-icon fa fa-pencil bigger-120"> </i>
                                </a>
                                <a class="blue" href="{{ route('courseAnswers.show', $data->uuid) }}">
                                    <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                </a>
                                <form method="POST" action="{{ route('courseAnswers.destroy', $data->uuid) }}">
                                    @csrf
                                    @method('DELETE')

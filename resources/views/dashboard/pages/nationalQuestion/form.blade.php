...
@section('form_input')
    <a href="{{ route('nationalQuestion.index') }}" class="btn btn-primary btn-xs">nationalQuestion</a>

    <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data"
    action="{{ route('nationalQuestion.store') }}">
    @csrf
        ...
        <div class="tab-content padding-4">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="reference">
                 ...
                 <div class="col-sm-4">
                     <textarea class="col-xs-10 col-sm-12" type="text" 
                         name="reference" id="reference" ></textarea>
                     @error('reference')
                         <div>{{ $message }}</div>
                     @enderror
                 </div>

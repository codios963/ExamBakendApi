...
@section('form_input')
    <a href="{{ route('collage.index') }}" class="btn btn-primary btn-xs">Collage</a>

    <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data"
    action="{{ route('collage.update',$collage->uuid) }}">
    @csrf
    @method('put')
    ...
    <div class="widget-main">
        ...
        <div class="tab-content padding-4">
                ...
                <label class="col-sm-2 control-label no-padding-right" for="name">
                 ...
                 <div class="col-sm-4">
                     <input class="col-xs-10 col-sm-5" type="text" 
                         name="name" id="name" value="{{$collage->name  }}" >
                     @error('name')
                         <div>{{ $message }}</div>
                     @enderror
                 </div>
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label no-padding-right" for="category_id">Category Name</label>
                <div class="col-sm-4">
                    <select class="col-xs-10 col-sm-5" name="category_id" id="category_id">
                        <option value="">{{$collage->category->name  }}</option>
